...
const sections = [
  ...
  { title: "8. Intellectual Property", content: "All content on our platform — including logos, text, images, graphics, and software — is the property of MediaMall or its licensors and is protected by Nigerian and international copyright laws. You may not reproduce, distribute, or create derivative works without our written permission." },
  { title: "9. Limitation of Liability", content: "MediaMall shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services. Our total liability shall not exceed the amount you paid for the specific product or service giving rise to the claim. This limitation applies to the fullest extent permitted by Nigerian law." },
  { title: "10. Dispute Resolution", content: "Any disputes arising from these terms shall first be resolved through good-faith negotiation. If unresolved, disputes will be submitted to mediation, and if necessary, to arbitration under the Arbitration and Conciliation Act of Nigeria. The laws of the Federal Republic of Nigeria govern these terms." },
  { title: "11. Contact", content: "For questions about these Terms of Service, contact us at legal@mediamall.ng or call 0800 MEDIAMALL." },
];
